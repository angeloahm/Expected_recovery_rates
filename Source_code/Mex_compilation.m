...
params.b_grid_max_lowr = 0.80;           % Maximum value of the low recovery bond grid.
params.b_grid_max_highr = 1.00;            % Maximum value of the high recovery bond grid.
params.b_grid_size_lowr = (params.b_grid_max_lowr/params.b_grid_max_highr) * (params.b_grid_size_highr-1)+1;
params.y_grid_size = 10;                 % Number of points in the grid for the income. (Always use Odd)
